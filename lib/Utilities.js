...
exports.wrapFieldObject = function (params) {
    ...
    const newObj = {};
    let newProp, propPreDefined, propFromKey;
    ...
    const prop = _.cloneDeep(propPreDefined || propFromKey || newProp);
...
exports.getRealPath = function (path_str, stack_index) {
    ...
    let cwd = process.cwd();
    const err = new Error();
    const tmp = err.stack.split(/\r?\n/)[typeof stack_index !== "undefined" ? stack_index : 3];
    let m;
